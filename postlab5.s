...
;
;Programa:	POSTLaboratorio5 (Contador binario de 8 bits con 2 botones de 
...
loop: 
   ...
   ;El valor del contador binario se pasa a una variable donde se realizarán
   ;los cálculos para poder hacer la operación. 
   movf PORTD, W 
   movwf valor_a_convertir  ;Segunda variable con valor en D para calculo 
...
configuracion_inicial:
    ...
    movlw 0b11111000	    ;2 bits de salida para puerto c(transistores mux)
    movwf TRISC
    ;Entradas
...
display_2:  
    movf    display_variable+2, w
    movwf   PORTA   ;DISPLAY
    bsf	    PORTC, 2 ;tRANSISOTOR
    goto    siguiente_display
...
binario_a_decimal: 
    ...
    calculo_centena:
    movlw 100
    subwf valor_a_convertir, W
    
    btfss STATUS, 0
    goto calculo_decena
    movwf valor_a_convertir
    incf CENTENA, F
    goto calculo_centena
    calculo_decena:
    movlw 10
    subwf valor_a_convertir, W
    btfss STATUS, 0
